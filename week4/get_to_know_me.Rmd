...
# This R Markdown is to get to know Megan!

## Bio {#bachelors-degree}

Bioinformatics & Computational Biology Specialist, Computer Science Major, Statistics Minor
...
courses4w <- read.csv(file = "courses.csv")

kable(courses4w, col.names = colnames(courses4w), escape = F) %>%
  kable_styling(latex_options = "hold_position")

```

Table 1. Description of courses that I'm taking in my last semester of fourth year.
